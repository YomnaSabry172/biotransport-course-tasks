% SBEG201 Biotransport - Full Integrated App (Frontend)
% Complete app (Parts 1–5) — FINAL VERSION (with Part 3 fully integrated)
% Save this file as: biotransport_full_app.m
...
classdef biotransport_full_app < matlab.apps.AppBase
    ...
    methods (Access = private)
        function startupFcn(app)
            try
                ...
                errordlg(['Error running backend RunCaseAnalysis: ' ME.message], 'Backend Error');
                ResultsTable = table();
    ...
    methods (Access = private)
        ...
        function ClearButtonPushed(app, ~)
            ...
            app.FlowRegimeEditField.BackgroundColor = [1 1 1];
        end
        ...
        function CalculateButtonPushed(app, ~)
            ...
            if rho <= 0 || v <= 0 || mu <= 0
                ...
                app.FlowRegimeEditField.BackgroundColor = [0.9 0.4 0.4];
                return;
            end
            ...
            if Re < 2000
                regime = 'LAMINAR'; color = [0.4 0.8 0.4];
            elseif Re < 4000
                regime = 'TRANSITIONAL'; color = [1 0.7 0.4];
            else
                regime = 'TURBULENT'; color = [0.9 0.4 0.4];
            end
        ...
        function RunAnalysisButtonPushed(app, ~)
            ...
            % ✅ NEW: Update Part 3 Friction plot
            try
                biotransport_analysis_functions('PlotFrictionFactor', app.UIAxes_Friction);
            catch ME
    ...
    methods (Access = private)
        function createComponents(app)
            ...
            app.UIFigure.Color = [0.7 0.8 1.0];
            app.UIFigure.Position = [100 100 1000 650];
            app.UIFigure.Name = 'SBEG201 Biotransport: Flow Analysis Tool';
            ...
            app.DarcyFrictionFactorfEditField.Position = [160 140 120 22];
